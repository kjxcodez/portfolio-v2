  ...
  return (
    <>
      <JsonLd schema={{
        ...
        name: "Contact | Kapil Kumar Jangid",
        description: "Get in touch with Kapil Kumar Jangid — open to full-time roles, freelance projects, and open source collaborations.",
