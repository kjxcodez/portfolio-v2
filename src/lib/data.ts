...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    github: "https://github.com/lang-rune/rune",
    type: 'language',
    featured: true,
    year: 2024,
    status: 'Live',
    screenshots: ['/rune-dark.png', '/rune-light.png', '/rune-docs.png', '/rune-extension.png', '/rune-downloads.png', '/rune-oss.png', '/rune-roadmap.png'],
    timeline: 'Late 2024',
    highlights: [
  ...
  },
  {
    ...
    github: "https://github.com/lang-rune/vscode",
    type: 'extension',
    featured: false,
    year: 2024,
    status: 'Live',
